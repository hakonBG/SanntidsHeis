...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>TTK4145/Project/driver/io.h at master · klasbo/TTK4145</title>
...
<meta content="SsN7bRjzabuzXQYM/m1vHRQvmUDmCcH7hiygyWP07cM=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-eedb06b089d2ef792059bc2ebee160f716fa7aab.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="59617e98acce9d59e36d799192b445af">
        ...
        <link data-pjax-transient rel='permalink' href='/klasbo/TTK4145/blob/64551ef1eca244838f734d143e8e8b40d256e88d/Project/driver/io.h'>
...
<!-- blob contrib key: blob_contributors:v21:f0eaf8d7ccfdbbf86e2f6c7034bccd40 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/klasbo/TTK4145/blob/master/Project/driver/io.h"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
  ...
  <div class="commit file-history-tease">
    ...
    <div class="participation">
      <p class="quickstat"><a href="#blob_contributors_box" rel="facebox"><strong>2</strong> contributors</a></p>
          <a class="avatar tooltipped downwards" title="klasbo" href="/klasbo/TTK4145/commits/master/Project/driver/io.h?author=klasbo"><img alt="klasbo" height="20" src="https://0.gravatar.com/avatar/15cebd3d1dfcbf51093ec71bb5649e2a?d=https%3A%2F%2Fidenticons.github.com%2Ff4f9cec9fec60d40d51bfdbb5894cc36.png&amp;r=x&amp;s=140" width="20" /></a>
    <a class="avatar tooltipped downwards" title="FWorren" href="/klasbo/TTK4145/commits/master/Project/driver/io.h?author=FWorren"><img alt="FWorren" height="20" src="https://2.gravatar.com/avatar/2c6f220a5887389e312a48085334a468?d=https%3A%2F%2Fidenticons.github.com%2Fe1a25ff1ee8d1df75858b4a83bfee064.png&amp;r=x&amp;s=140" width="20" /></a>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list">
          ...
          <li class="facebox-user-list-item">
            <img alt="FWorren" height="24" src="https://2.gravatar.com/avatar/2c6f220a5887389e312a48085334a468?d=https%3A%2F%2Fidenticons.github.com%2Fe1a25ff1ee8d1df75858b4a83bfee064.png&amp;r=x&amp;s=140" width="24" />
      ...
      <div class="actions">
        <div class="button-group">
                <a class="minibutton tooltipped upwards js-update-url-with-hash"
                   ...
                   href="/klasbo/TTK4145/edit/master/Project/driver/io.h"
                   data-method="post" rel="nofollow">Edit</a>
          <a href="/klasbo/TTK4145/raw/master/Project/driver/io.h" class="button minibutton " id="raw-url">Raw</a>
            <a href="/klasbo/TTK4145/blame/master/Project/driver/io.h" class="button minibutton js-update-url-with-hash">Blame</a>
          <a href="/klasbo/TTK4145/commits/master/Project/driver/io.h" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
          <a class="minibutton danger empty-icon tooltipped downwards"
             href="/klasbo/TTK4145/delete/master/Project/driver/io.h"
...
<span id="L62" rel="#L62">62</span>
            ...
            <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'><span class="c1">// Wrapper for libComedi I/O.</span></div><div class='line' id='LC2'><span class="c1">// These functions provide and interface to libComedi limited to use in</span></div><div class='line' id='LC3'><span class="c1">// the real time lab.</span></div><div class='line' id='LC4'><span class="c1">//</span></div><div class='line' id='LC5'><span class="c1">// 2006, Martin Korsgaard</span></div><div class='line' id='LC6'><span class="cp">#ifndef __INCLUDE_IO_H__</span></div><div class='line' id='LC7'><span class="cp">#define __INCLUDE_IO_H__</span></div><div class='line' id='LC8'><br/></div><div class='line' id='LC9'><br/></div><div class='line' id='LC10'><br/></div><div class='line' id='LC11'><span class="cm">/**</span></div><div class='line' id='LC12'><span class="cm">  Initialize libComedi in &quot;Sanntidssalen&quot;</span></div><div class='line' id='LC13'><span class="cm">  @return Non-zero on success and 0 on failure</span></div><div class='line' id='LC14'><span class="cm">*/</span></div><div class='line' id='LC15'><span class="kt">int</span> <span class="nf">io_init</span><span class="p">();</span></div><div class='line' id='LC16'><br/></div><div class='line' id='LC17'><br/></div><div class='line' id='LC18'><br/></div><div class='line' id='LC19'><span class="cm">/**</span></div><div class='line' id='LC20'><span class="cm">  Sets a digital channel bit.</span></div><div class='line' id='LC21'><span class="cm">  @param channel Channel bit to set.</span></div><div class='line' id='LC22'><span class="cm">*/</span></div><div class='line' id='LC23'><span class="kt">void</span> <span class="nf">io_set_bit</span><span class="p">(</span><span class="kt">int</span> <span class="n">channel</span><span class="p">);</span></div><div class='line' id='LC24'><br/></div><div class='line' id='LC25'><br/></div><div class='line' id='LC26'><br/></div><div class='line' id='LC27'><span class="cm">/**</span></div><div class='line' id='LC28'><span class="cm">  Clears a digital channel bit.</span></div><div class='line' id='LC29'><span class="cm">  @param channel Channel bit to set.</span></div><div class='line' id='LC30'><span class="cm">*/</span></div><div class='line' id='LC31'><span class="kt">void</span> <span class="nf">io_clear_bit</span><span class="p">(</span><span class="kt">int</span> <span class="n">channel</span><span class="p">);</span></div><div class='line' id='LC32'><br/></div><div class='line' id='LC33'><br/></div><div class='line' id='LC34'><br/></div><div class='line' id='LC35'><span class="cm">/**</span></div><div class='line' id='LC36'><span class="cm">  Writes a value to an analog channel.</span></div><div class='line' id='LC37'><span class="cm">  @param channel Channel to write to.</span></div><div class='line' id='LC38'><span class="cm">  @param value Value to write.</span></div><div class='line' id='LC39'><span class="cm">*/</span></div><div class='line' id='LC40'><span class="kt">void</span> <span class="nf">io_write_analog</span><span class="p">(</span><span class="kt">int</span> <span class="n">channel</span><span class="p">,</span> <span class="kt">int</span> <span class="n">value</span><span class="p">);</span></div><div class='line' id='LC41'><br/></div><div class='line' id='LC42'><br/></div><div class='line' id='LC43'><br/></div><div class='line' id='LC44'><span class="cm">/**</span></div><div class='line' id='LC45'><span class="cm">  Reads a bit value from a digital channel.</span></div><div class='line' id='LC46'><span class="cm">  @param channel Channel to read from.</span></div><div class='line' id='LC47'><span class="cm">  @return Value read.</span></div><div class='line' id='LC48'><span class="cm">*/</span></div><div class='line' id='LC49'><span class="kt">int</span> <span class="nf">io_read_bit</span><span class="p">(</span><span class="kt">int</span> <span class="n">channel</span><span class="p">);</span></div><div class='line' id='LC50'><br/></div><div class='line' id='LC51'><br/></div><div class='line' id='LC52'><br/></div><div class='line' id='LC53'><br/></div><div class='line' id='LC54'><span class="cm">/**</span></div><div class='line' id='LC55'><span class="cm">  Reads a bit value from an analog channel.</span></div><div class='line' id='LC56'><span class="cm">  @param channel Channel to read from.</span></div><div class='line' id='LC57'><span class="cm">  @return Value read.</span></div><div class='line' id='LC58'><span class="cm">*/</span></div><div class='line' id='LC59'><span class="kt">int</span> <span class="nf">io_read_analog</span><span class="p">(</span><span class="kt">int</span> <span class="n">channel</span><span class="p">);</span></div><div class='line' id='LC60'><br/></div><div class='line' id='LC61'><span class="cp">#endif </span><span class="c1">// #ifndef __INCLUDE_IO_H__</span></div><div class='line' id='LC62'><br/></div></pre></div></td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.04215s from github-fe119-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
